...
class CardBigWeather extends StatelessWidget {
  const CardBigWeather({super.key, required this.tag, required this.temp, required this.tempmin, required this.tempmax, required this.nameLocation, required this.urlStatusIcon, required this.descriptionWeather});
